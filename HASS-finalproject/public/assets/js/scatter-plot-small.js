...
let margin1 = { top: 0, right: 0, bottom: 0, left: 30 };
let width1 = 400 - margin1.left - margin1.right;
let height1 = 170 - margin1.top - margin1.bottom;

// append the svg object to the body of the page
let svg1 = d3
  .select("#scatterplot-small")
  .append("svg")
  .attr("width", "100%")
  .attr("height", "100%")
...
function scatterplot_update() {
  ...
  .then(function (data) {
    ...
    svg1.append("text")
      .attr("x", width1 / 2)
      .attr("y", (height1 + 10)) // Adjust position as needed
